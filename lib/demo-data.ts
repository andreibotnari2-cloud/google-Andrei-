export const MCC_ACCOUNTS = [
  {
    ...
    accounts: [
      { id: '183-473-0014', name: 'BoardShop.MD',       currency: 'USD', status: 'active', paymentStatus: 'paid' },
      { id: '542-339-5360', name: 'Lagmar',              currency: 'USD', status: 'active', paymentStatus: 'paid' },
      { id: '622-030-8778', name: 'Little Dent',         currency: 'USD', status: 'active', paymentStatus: 'paid' },
      { id: '412-048-6196', name: 'Metalica Zuev',       currency: 'USD', status: 'active', paymentStatus: 'paid' },
      { id: '150-945-9631', name: 'Orthodontica.md',     currency: 'USD', status: 'active', paymentStatus: 'paid' },
      { id: '462-332-1254', name: 'Profilactix',         currency: 'USD', status: 'active', paymentStatus: 'paid' },
      { id: '984-594-5688', name: 'SUPRATEN Bussines',   currency: 'USD', status: 'active', paymentStatus: 'paid' },
      { id: '751-564-5708', name: 'StarNet',             currency: 'USD', status: 'active', paymentStatus: 'paid' },
      { id: '415-655-2227', name: 'Top Estate',          currency: 'EUR', status: 'active', paymentStatus: 'paid' },
      { id: '337-121-6713', name: 'Work Finder EU',      currency: 'EUR', status: 'active', paymentStatus: 'paid' },
      { id: '644-444-9213', name: 'XAuto',               currency: 'USD', status: 'active', paymentStatus: 'paid' },
    ],
  },
];
